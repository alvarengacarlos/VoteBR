    ...
    <div class="container">
        <header>
            <ul>
                ...
                <li><a href="{{ route('elector.view-results-in-progress') }}">Resultados atuais</a></li> 
                <li><a href="{{ route('elector.view-results-closed') }}">Resultados anterirores</a></li>                 
        ...
        <footer>            
            <ul>
                ...
                <li><a href="{{ route('admin.login') }}" target="_blank"><img src="{{ asset('img/icon-cadeado-preto-fechado.png') }}" alt="ícone de cadeado de cor preta fechado" width="20"></a></li>
            </ul>           
        </footer>        
    </div>
</body>
